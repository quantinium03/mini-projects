...
int main() {
  long double loan_amount, interest_rate, number_of_years, total_amount,
      monthly_amount;
  ...
  total_amount = (number_of_years * loan_amount) +
                 (number_of_years * loan_amount * (interest_rate / 100.00));
